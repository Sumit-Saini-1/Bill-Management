...
const { serveHomePage, serveLoginPage, serveHistoryPage, serveStockPage, loginUser, getProducts, newBill, generateInvoiceNumber, historyOfBills } = require("../controllers/userControllers");
